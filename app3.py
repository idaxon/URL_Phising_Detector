...
# --- Main App ---
st.set_page_config(page_title="Phishing URL Detector (Ultra Accurate)", layout="wide", page_icon=":shield:")
st.title(":shield: Phishing URL Detector (Ultra Accurate)")
st.markdown("""
This app uses a highly accurate machine learning model trained on a combined phishing URL dataset to detect if a link is phishing or legitimate. Enter a URL below to analyze it.
""")
...
with st.spinner("Loading data and training model..."):
    ...
    model = RandomForestClassifier(n_estimators=500, max_depth=30, min_samples_leaf=1, random_state=42, class_weight='balanced_subsample')
